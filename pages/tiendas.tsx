...
const tiendaFormSchema = Yup.object().shape({
    ...
    storeName: Yup.string().required("Campo requerido").min(3, "El nombre tiene que tener al menos un carácter").max(100, "El nombre no puede superar los 100 carácteres"),
    storeDireccion: Yup.string().required("Campo requerido").min(3, "El apellido tiene que tener al menos un carácter").max(100, "El apellido no puede superar los 100 carácteres"),
